...
public class ListMenuItem : ListBoxItem
{

    public static readonly StyledProperty<object?> IconProperty =
       AvaloniaProperty.Register<ListMenuItem, object?>(nameof(Icon));
    ...
    public static readonly StyledProperty<string?> HeaderProperty =
        AvaloniaProperty.Register<ListMenuItem, string?>(nameof(Header));
    ...
    public static readonly StyledProperty<object> PageContentProperty =
        AvaloniaProperty.Register<ListMenuItem, object>(nameof(PageContent));
    ...
    protected override void OnPointerPressed(PointerPressedEventArgs e)
    {
        ...
        if (!e.Handled && ItemsControl.ItemsControlFromItemContaner(this) is ListMenu owner)
        {
    ...
    public static readonly StyledProperty<bool> IsTopMenuExpandedProperty =
        AvaloniaProperty.Register<ListMenuItem, bool>(nameof(IsTopMenuExpanded), defaultValue: true);
