...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public override void Initialize()
        {
            ...
            {
                SukiHost.ShowToast("错误提示", $"Unhandled task exception: {ex.Message} {Environment.NewLine} {ex.InnerException?.Message}", TimeSpan.FromSeconds(20), () => Console.WriteLine(ex.Message));
            });
        }
        ...
        {
            e.SetObserved();
            SukiHost.ShowToast("错误提示", $"Unhandled task exception: {e.Exception.Message}", TimeSpan.FromSeconds(20), () => Console.WriteLine("Toast clicked !"));
        }
    }
}